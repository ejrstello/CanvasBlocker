...
exports.notify = function({url, errorStack, isCF, isToShow}, {lists, notificationPref, _, browser, window}){
			...
			var buttons = [
				{
					...
					callback: function(){
						...
						if (notification.isCF) {
							...
							isCF_msg = "There is Canvas,\n but there isn't Canvas Fingerprint!";
						}
						window.alert(isCF_msg);
